...
export default extendTheme({
  shadows: {
    ...
    // },
    "invalid-focus": `.1rem -.1rem 0 .1rem rgba(138, 56, 58, 1), 0 0 .8rem .4rem rgba(0,0,0, .3)`,
    "invalid-hover": `.1rem -.1rem 0 .1rem rgba(138, 56, 58, 1), 0 0 1.6rem .8rem rgba(0,0,0, .3)`,
    "valid-hover": `.1rem -.1rem 0 .1rem rgba(62, 150, 99, 1), 0 0 1.6rem .8rem rgba(0,0,0, .3)`,
    "valid-focus": `.1rem -.1rem 0 .1rem rgba(62, 150, 99, 1), 0 0 1.6rem .8rem rgba(0,0,0, .3)`,
    "default-focus": `.1rem -.1rem 0 .1rem rgba(88, 214, 140, 1), 0 0 .8rem .4rem rgba(0,0,0, .3)`,
    "default-hover": `.1rem -.1rem 0 .1rem rgba(88, 214, 140, 1), 0 0 1.6rem .8rem rgba(0,0,0, .3)`,
    // Primary: {
